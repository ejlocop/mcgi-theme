...
<div class="tiles__item --card --revealed">
	<div class="tiles__item__content">
		<div class="tiles__item__thumbnail">
			<img data-id="gallery-<?php echo $tile_data['id']; ?>" class="tiles__item__thumbnail__img" src="<?php echo $tile_data['thumbnail'] ?>" data-lazy="<?php echo $tile_data['thumbnail'] ?>" data-no-lazy="1">
		</div>
	</div>
</div>
